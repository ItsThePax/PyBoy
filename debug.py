opcodeNames = {
    0x00: 'NOP',          0x01: 'LD BC,{0}', 0x02: 'LD (BC),A',  0x03: 'INC BC',    0x04: 'INC B',       0x05: 'DEC B',     0x06: 'LD B,{0}',    0x07: 'RCLA',
    0x08: 'LD ({0}),SP',  0x09: 'ADD HL,BC', 0x0a: 'LD A,(BC)',  0x0b: 'DEC BC',    0x0c: 'INC C',       0x0d: 'DEC C',     0x0e: 'LD C,{0}',    0x0f: 'RRCA',
    0x10: 'STOP 0',       0x11: 'LD DE,{0}', 0x12: 'LD (DE),A',  0x13: 'INC DE',    0x14: 'INC D',       0x15: 'DEC D',     0x16: 'LD D,{0}',    0x17: 'RLA',
    0x18: 'JR {0}',       0x19: 'ADD HL,DE', 0x1a: 'LD A,(DE)',  0x1b: 'DEC DE',    0x1c: 'INC E',       0x1d: 'DEC E',     0x1e: 'LD E,{0}',    0x1f: 'RRA',
    0x20: 'JR NZ,{0}',    0x21: 'LD HL,{0}', 0x22: 'LD (HL+),A', 0x23: 'INC HL',    0x24: 'INC H',       0x25: 'DEC H',     0x26: 'LD H,{0}',    0x27: 'DAA',
    0x28: 'JR Z,{0}',     0x29: 'ADD HL,HL', 0x2a: 'LD A,(HL+)', 0x2b: 'DEC HL',    0x2c: 'INC L',       0x2d: 'DEC L',     0x2e: 'LD L,{0}',    0x2f: 'CPL',
    0x30: 'JR NC,{0}',    0x31: 'LD SP,{0}', 0x32: 'LD (HL-),A', 0x33: 'INC SP',    0x34: 'INC (HL)',    0x35: 'DEC (HL)',  0x36: 'LD (HL),{0}', 0x37: 'SCF',
    0x38: 'JR C,{0}',     0x39: 'ADD HL,SP', 0x3a: 'LD A,(HL-)', 0x3b: 'DEC SP',    0x3c: 'INC A',       0x3d: 'DEC A',     0x3e: 'LD A,{0}',    0x3f: 'CCF',
    ...
    0xc0: 'RET NZ',       0xc1: 'POP BC',    0xc2: 'JP NZ,{0}',  0xc3: 'JP {0}',    0xc4: 'CALL NZ,{0}', 0xc5: 'PUSH BC',   0xc6: 'ADD A,{0}',   0xc7: 'RST 00H',
    0xc8: 'RET Z',        0xc9: 'RET',       0xca: 'JP Z,{0}',   0xcb: 'PREFIX CB', 0xcc: 'CALL Z,{0}',  0xcd: 'CALL {0}',  0xce: 'ADC A,{0}',   0xcf: 'RST 08H',
    0xd0: 'RET NC',       0xd1: 'POP DE',    0xd2: 'JP NC,{0}',  0xd3: 'Invalid',   0xd4: 'CALL NC,{0}', 0xd5: 'PUSH DE',   0xd6: 'SUB {0}',     0xd7: 'RST 10H',
    0xd8: 'RET C',        0xd9: 'RETI',      0xda: 'JP C,{0}',   0xdb: 'Invalid',   0xdc: 'CALL C,{0}',  0xdd: 'Invalid',   0xde: 'SBC A,{0}',   0xdf:'RST 18H',
    0xe0: 'LDH ({0}),A',  0xe1: 'POP HL',    0xe2: 'LD (C),A',   0xe3: 'Invalid',   0xe4: 'Invalid',     0xe5: 'PUSH HL',   0xe6: 'AND {0}',     0xe7: 'RST 20H',
    0xe8: 'ADD SP,{0}',   0xe9: 'JP (HL)',   0xea: 'LD ({0}),A', 0xeb: 'Invalid',   0xec: 'Invalid',     0xed: 'Invalid',   0xee: 'XOR {0}',     0xef: 'RST 28H',
    0xf0: 'LDH A,({0})',  0xf1: 'POP AF',    0xf2: 'LD A,(C)',   0xf3: 'DI',        0xf4: 'Invalid',     0xf5: 'PUSH AF',   0xf6: 'OR {0}',      0xf7: 'RST 30H',
    0xf8: 'LD HL,SP+{0}', 0xf9: 'LD SP,HL',  0xfa: 'LD A,({0})', 0xfb: 'EI',        0xfc: 'Invalid',     0xfd: 'Invalid',   0xfe: 'CP {0}',      0xff: 'RST 38H'}
    ...
    if length == 1:
        ...
        if instructions[0] in [0x18, 0x20, 0x28, 0x30, 0x38, 0xe8, 0xf8]:
            ...
            if instructions[0] in [0xe8, 0xf8]:
                 return opcodeNames[instructions[0]].format(hex(registers[0] + offset))
            return opcodeNames[instructions[0]].format(hex(registers[1] + offset + 2))
        elif instructions[0] in [0xcb, 0x20]:
            return opcodeNames[instructions]
        elif instructions[0] in [0xe0, 0xe2, 0xf0, 0xf2]:
            return opcodeNames[instructions[0]].format(hex(0xff00 + instructions[1]))
        else:
             return opcodeNames[instructions[0]].format(hex(instructions[1]))
    elif length == 3:
         return opcodeNames[instructions[0]].format(hex(instructions[2] << 8 | instructions[1]))
